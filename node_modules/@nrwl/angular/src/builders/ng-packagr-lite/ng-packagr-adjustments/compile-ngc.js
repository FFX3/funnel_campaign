...
exports.NX_COMPILE_NGC_TRANSFORM = exports.compileNgcTransformFactory = void 0;
...
exports.compileNgcTransformFactory = (StylesheetProcessor) => {
...
exports.NX_COMPILE_NGC_TRANSFORM = transform_di_1.provideTransform({
    provide: compile_ngc_di_1.COMPILE_NGC_TOKEN,
    useFactory: exports.compileNgcTransformFactory,
