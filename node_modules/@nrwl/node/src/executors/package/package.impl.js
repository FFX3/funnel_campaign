...
function packageExecutor(options, context) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield compile_typescript_files_1.default(normalizedOptions, context, libRoot, dependencies);
        yield copy_asset_files_1.default(normalizedOptions, context);
