...
function updatePackageJson(options, context) {
    ...
    packageJson.main = devkit_1.normalizePath(`${options.relativeMainFileOutput}/${mainJsFile}`);
    packageJson.typings = devkit_1.normalizePath(`${options.relativeMainFileOutput}/${typingsFile}`);
