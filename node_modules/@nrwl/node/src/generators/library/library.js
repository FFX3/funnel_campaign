...
function libraryGenerator(tree, schema) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        const libraryInstall = yield generators_1.libraryGenerator(tree, Object.assign(Object.assign({}, schema), { importPath: options.importPath }));
...
function createFiles(tree, options) {
    const nameFormats = devkit_1.names(options.name);
