...
function createFiles(host, options) {
    devkit_1.generateFiles(host, devkit_1.joinPathFragments(__dirname, './files/lib'), options.projectRoot, Object.assign(Object.assign(Object.assign({}, options), devkit_1.names(options.name)), { strict: undefined, tmpl: '', offsetFromRoot: devkit_1.offsetFromRoot(options.projectRoot) }));
    if (!options.publishable && !options.buildable) {
